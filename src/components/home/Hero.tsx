      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold font-poppins leading-tight mb-6 animate-fade-in">
            <span className="block">Diseño web moderno que</span>
            <span className="gradient-text">posiciona tu marca desde el primer clic</span>
          </h1>
          
          <p className="text-xl md:text-2xl text-tech-gray mb-8 animate-fade-in" style={{animationDelay: '0.2s'}}>
            Sitios estáticos, rápidos, visuales y 100% personalizados
          </p>
          
          <div className="flex flex-col sm:flex-row justify-center gap-4 animate-fade-in" style={{animationDelay: '0.4s'}}>
            <a
              href="https://wa.me/5215555555555?text=Hola,%20me%20interesa%20un%20sitio%20web%20personalizado"
              target="_blank"
            ...
            <NavLink to="/proyectos" className="tech-btn-outline flex items-center justify-center gap-2">
              Ver proyectos
              <ArrowRight size={18} />
            </NavLink>
          </div>
        ...
        <div className="absolute -bottom-10 -right-10 md:bottom-10 md:right-0 text-white/10 font-mono text-xs opacity-50 parallax whitespace-nowrap" data-speed="10">
          ...
          <div>  &lt;header&gt;Diseño Moderno&lt;/header&gt;</div>
